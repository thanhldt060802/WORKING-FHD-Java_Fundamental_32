...
public class Developer extends Employee {
    ...
    public String toString() {
        return String.format("Developer [id=%s, name=%s, salary=%d," +
        "coefficientsSalary=%f, hourOfOvertime=%d," +
        "bonusPerHourOfOvertime=%f]", super.getId(), super.getName(), super.getSalary(),
        super.getCoefficientsSalary(), this.hourOfOvertime, this.bonusPerHourOfOvertime);
    }
