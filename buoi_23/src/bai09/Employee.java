...
public class Employee {
    ...
    public Employee(String id, String name, int hourOfTimeserving, double salaryPerHourOfTimeserving, int hourOfOvertime, double bonusSalaryPerHourOfOvertime) {
        this.id = id;
        this.name = name;
    ...
    public double calculateActualSalary() {
        return hourOfTimeserving * salaryPerHourOfTimeserving + hourOfOvertime * bonusSalaryPerHourOfOvertime;
    }
    ...
    public String toString() {
        return "Employee [id=" + id + ", name=" + name + ", hourOfTimeserving=" + hourOfTimeserving
                ...
                + ", bonusSalaryPerHourOfOvertime=" + bonusSalaryPerHourOfOvertime + "] => Actual salary: "
